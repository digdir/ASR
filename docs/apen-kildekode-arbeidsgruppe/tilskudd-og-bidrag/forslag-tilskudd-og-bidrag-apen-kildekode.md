...
Forslaget i denne siden er å jobbe på tre nivåer:

1. **Tiltak virksomheter kan gjøre selv nå**  
...
2. **Tiltak som kan prøves ut gjennom eksisterende virkemidler**  
...
3. **Tiltak som krever videre utredning**  
   Eksempler er en nasjonal støtteordning, en tverr-offentlig finansieringspott, offentlig sponsorordning, felles modell for vedlikehold av kritiske åpne komponenter og ordninger for speiling, arkivering eller sikring av kritiske avhengigheter.
...
Denne siden handler særlig om det tredje punktet: **bidra**. Samtidig henger bidrag tett sammen med både bruk og deling. Jo mer offentlig sektor bruker og deler åpen kildekode, desto viktigere blir det å ha modeller for vedlikehold, sikkerhet, dokumentasjon, finansiering og langsiktig forvaltning.
...
Åpen kildekode gir offentlig sektor større kontroll over digitale byggesteiner, men bare dersom vi også investerer i kompetanse, vedlikehold og fellesskap. Hvis offentlig sektor bare henter verdi ut av åpne prosjekter uten å bidra tilbake, blir vi sårbare for at små miljøer forsvinner, at prosjekter endrer retning, eller at viktig kompetanse blir utilgjengelig.
...
Å bidra tilbake kan bety flere ting enn å betale penger. Offentlig sektor kan bidra med både tid, kompetanse, krav, infrastruktur og finansiering.
...
- issue-triage
- kodegjennomgang
- brukererfaringer og behovsbeskrivelser
- bidrag til veikart og prioriteringer

### Organisatoriske bidrag

- deltakelse i styringsgrupper, fagfora og brukerfellesskap
- etablering av felles forvaltningsmodeller
- koordinering mellom virksomheter som bruker samme løsning
- synliggjøring av offentlige behov i åpne prosjekter
- etablering av kontaktpunkter, prosesser og roller for åpen kildekode

### Økonomiske bidrag

- kjøp av utvikling, vedlikehold, drift, sikkerhetsarbeid eller support
- sponsorordninger
- medlemskap i stiftelser eller organisasjoner
- direkte bidrag via faktura eller fiscal host
- tilskudd, programmidler eller fond
- spleiselag mellom virksomheter
- støtte til sikkerhetsrevisjoner eller dokumentasjonsløft

### Infrastruktur- og beredskapsbidrag

- speiling av pakkeregistre
- speiling eller arkivering av kildekode
- testmiljøer og bygginfrastruktur
- sikker lagring av kritiske avhengigheter
- støtte til dokumentasjonssider og distribusjonsinfrastruktur
- beredskapsmekanismer dersom sentrale tjenester blir utilgjengelige

### Bidrag gjennom anskaffelser

- krav til dokumenterte åpne avhengigheter
- krav til sårbarhetshåndtering og oppdateringsrutiner
- krav om at forbedringer bidras tilbake der det er hensiktsmessig
- krav til lisens, dokumentasjon og overlevering
- krav som reduserer unødvendige proprietære tilpasninger
- kjøp av vedlikehold, support og forvaltning rundt åpne løsninger

## Hvilke behov skal tiltakene møte?

Før tiltak vurderes, bør vi være tydelige på hvilke behov de skal svare på. Sentrale behov er:
...
Sårbarhetshåndtering, sikkerhetsrevisjoner, trygg leveransekjede, signering, attestering, avhengighetsstyring og rask respons ved hendelser.
...
Stabile pakkeregistre, byggesystemer, testmiljøer, speiling, arkivering, kataloger og dokumentasjonssider.
...
Et leverandørmarked der flere aktører kan tilby drift, support, videreutvikling og rådgivning rundt åpne løsninger, i stedet for at offentlig sektor låses til én leverandør eller én proprietær implementering.
...
- innsending av forbedringer tilbake til originalprosjektet i stedet for å vedlikeholde lokale fork-er

Dette bør ikke nødvendigvis styres med en fast prosentsats for alle. Noen bidrag er små og løpende, mens andre kan være større enkeltbidrag som reduserer risiko eller vedlikeholdskostnader i egen løsning. Et mulig utgangspunkt kan likevel være at virksomheter vurderer en norm, for eksempel at utviklere kan bruke en mindre andel av arbeidstiden på relevante åpne prosjekter når det er knyttet til virksomhetens behov.
...
- Kartlegg de viktigste åpne komponentene teamet er avhengig av.
- Velg én til tre komponenter der bidrag vil redusere risiko eller forbedre kvalitet.
- Avklar hvem som kan godkjenne arbeidstid brukt på bidrag.
- Avklar en enkel praksis for lisens, sikkerhet og kommunikasjon med eksterne prosjekter.
- Start med små bidrag: dokumentasjon, feilrapporter, tester eller enkle feilrettinger.

**Bør avklares:**

- hvordan arbeidstid prioriteres mot interne leveranser
- hvem som eier bidraget
- hvordan lisens- og opphavsrettsspørsmål håndteres
- hvordan sikkerhetsfunn rapporteres
- om bidrag skal registreres eller synliggjøres internt
...
- migrering
- opplæring
- forvaltning og release-arbeid

Det kan også vurderes krav om at leverandører:

- dokumenterer åpne avhengigheter, for eksempel gjennom SBOM eller tilsvarende oversikt
- har rutiner for sårbarhetshåndtering
- bidrar forbedringer tilbake til prosjekter de bygger på, der det er hensiktsmessig
...
- hvordan vedlikehold og support prises og følges opp
...
- fakturabaserte bidrag
- medlemskap i stiftelser eller organisasjoner
- støtte til konkrete vedlikeholds- eller sikkerhetsoppgaver
...
- Identifiser kritiske avhengigheter som allerede har en tydelig støttemodell.
- Undersøk om mottaker kan fakturere eller om støtten går via en juridisk enhet.
- Avklar internt om bidraget kan håndteres som medlemskap, kjøp, sponsorat, tilskudd eller annen budsjettpost.
- Start eventuelt med en pilot der beløp, mottaker og rapportering er enkle å dokumentere.
...
Tilskudd kan være riktig virkemiddel når målet er bred samfunnsnytte og når gevinsten ikke naturlig kan finansieres av én enkelt virksomhet. Samtidig er etablering av tilskuddsordninger normalt mer omfattende enn enkle virksomhetstiltak eller anskaffelser. Det krever politisk og forvaltningsmessig avklaring, tydelig formål, regelverk, kriterier, forvaltning, kontroll og rapportering.

**Mulige spor:**

1. **Etableringsspor**  
   Støtte til nye eller tidlige åpne prosjekter som trenger midler for å bli gjenbrukbare: lisens, dokumentasjon, sikkerhet, test, pakking og første forvaltningsmodell.
...
- Definere hva som menes med offentlig nytte og kritisk digital infrastruktur.
- Vurdere om ordningen bør være nasjonal, sektorvis eller tverr-offentlig.
- Vurdere forholdet til statsstøtte, tilskuddsregelverk, anskaffelser og Støtteregisteret.
...
Der flere offentlige virksomheter bruker samme åpne løsning, kan de gå sammen om å finansiere forvaltning og videreutvikling.
...
- felles anskaffelse av vedlikehold eller support
- felles finansiering av en kjernegruppe

Fordelen er at kostnader og prioriteringer deles. Ulempen er at det krever tydelig styring, mandat og avklaring av ansvar.

**Første steg:**

- Finn løsninger eller komponenter som brukes av flere virksomheter.
- Etabler en enkel oversikt over felles behov.
- Avklar hvem som kan ta koordinerende rolle.
- Start med et avgrenset felles tiltak, for eksempel dokumentasjon, sikkerhetsgjennomgang eller vedlikeholdsavtale.
- Vurder om modellen bør formaliseres over tid.

**Bør avklares:**

- hvem som eier veikartet
- hvem som prioriterer endringer
- hvordan kostnader fordeles
- hvordan leverandører kan konkurrere om oppgaver
- hvordan resultatene deles tilbake
- hvordan nye virksomheter kan slutte seg til
...
- PyPI
- containerregistre
- GitHub og andre kildekodeplattformer
...
- Kartlegg hvilke pakkeregistre og kodeplattformer offentlige virksomheter er mest avhengige av.
- Vurder hvilke komponenter som er kritiske nok til speiling eller arkivering.
- Start med et begrenset pilotområde, for eksempel ett økosystem eller én sektor.
- Vurder krav til integritet, signering, metadata, sikkerhet, tilgangsstyring og oppdateringsfrekvens.
- Avklar hvem som skal drifte, finansiere og forvalte speilet.

**Bør avklares:**

- kostnad og driftsansvar
- sikkerhet og integritet
- lisens- og bruksrettigheter
- risiko for å distribuere sårbare eller kompromitterte pakker
- hvordan speilet holdes oppdatert
- hvordan virksomheter skal ta speilet i bruk
- om tiltaket bør være nasjonalt, sektorvis eller virksomhetsinternt
...
Noen prosjekter bruker bounties for å betale for konkrete oppgaver, feilrettinger eller sikkerhetsfunn. Dette kan fungere for:
...
### Open Source Pledge og frivillige forpliktelser

Open Source Pledge er et eksempel på en modell der virksomheter forplikter seg til å støtte åpne prosjekter de er avhengige av. Slike modeller kan være relevante som inspirasjon for offentlig sektor, men må tilpasses offentlige budsjett-, anskaffelses- og styringsrammer.

En offentlig variant kan for eksempel være at virksomheter forplikter seg til å:

- kartlegge kritiske åpne avhengigheter
- prioritere bidrag til et utvalg av dem
- rapportere bidrag åpent
- bidra med både penger, kode, dokumentasjon og arbeidstid
- samordne bidrag med andre offentlige virksomheter

## Forslag til statlig støtteordning eller tverr-offentlig finansieringspott

En nasjonal støtteordning bør vurderes dersom eksisterende virkemidler ikke er tilstrekkelige til å finansiere kritiske åpne komponenter og fellesgoder offentlig sektor er avhengig av.
...
Ordningen bør ikke begrenses til nyutvikling. Den bør også kunne dekke aktiviteter som ofte faller mellom budsjetter og anskaffelser:
...
- etablering av SBOM, lisensoversikt og sårbarhetsrutiner
- arkivering, speiling eller sikring av kritiske avhengigheter

### Tildelingskriterier

Søknader bør vurderes etter noen få tydelige kriterier:
...
For å unngå at ordningen blir en generell utviklingspott, bør mottakere forplikte seg til noen grunnkrav:

- åpen lisens
- offentlig tilgjengelig kildekode og dokumentasjon
- tydelig kontaktpunkt
- plan for vedlikehold og ansvar
- rutine for sårbarhetsrapportering
- oversikt over avhengigheter og lisenser
- enkel rapportering på bruk av midler og oppnådde resultater
- publisering av resultater slik at andre kan gjenbruke dem
- bidrag tilbake til relevante oppstrømsprosjekter der det er aktuelt

### Mulig styringsmodell

En ordning bør ha en enkel, transparent og faglig forankret styringsmodell. Den kan for eksempel bestå av:

- et sekretariat som forvalter ordningen
- et faglig råd som vurderer nytte, kritikalitet og gjenbrukspotensial
...
Dersom støtteordningen innebærer statsstøtte etter EØS-reglene, må støtteordninger og tildelinger håndteres i tråd med kravene som gjelder for Støtteregisteret. Dette bør avklares tidlig. Støtteregisteret kan også være relevant som kilde til å forstå hvordan eksisterende støtteordninger og tildelinger er strukturert og publisert.
...
Virksomheter bør starte med å kartlegge:
...
- hvilke prosjekter som har svak vedlikeholdskapasitet
- hvilke komponenter som har høy migreringskostnad
- hvilke komponenter som har sikkerhets- eller livsløpsrisiko

Dette kan gjøres gjennom avhengighetslister, SBOM, sårbarhetsskanning, dialog med leverandører, arkitekturarbeid og tverrsektorielle kartlegginger.

### Vurderingsspørsmål

For hvert prosjekt eller komponent bør det vurderes:

1. Hvor mange offentlige virksomheter bruker komponenten?
2. Brukes komponenten i kritiske eller samfunnsviktige tjenester?
3. Hvor aktivt vedlikeholdes prosjektet?
4. Hvor avhengig er prosjektet av enkeltpersoner?
5. Finnes det kjente sikkerhetsutfordringer eller teknisk gjeld?
6. Hvor vanskelig er det å bytte til et alternativ?
7. Finnes det en tydelig juridisk enhet eller mottaker for støtte?
8. Kan bidrag gi offentlig nytte utover én virksomhet?
9. Kan bidraget styrke gjenbruk, dokumentasjon eller interoperabilitet?
10. Finnes det en realistisk plan for videre forvaltning?
...
- støtte til dokumentasjon, sikkerhet og forvaltningsarbeid gjennom eksisterende programmer
...
## Foreslått redaksjonell struktur for siden

For å gjøre siden mer lesbar bør den ikke ha et tydelig skille mellom «første del» og «innspill». Innholdet bør samles i én helhetlig tekst.

Foreslått struktur:

1. Kort oppsummert
2. Sammenheng med arbeidsgruppens øvrige arbeid
3. Hvorfor bør offentlig sektor bidra tilbake?
4. Hva mener vi med å bidra?
5. Hvilke behov skal tiltakene møte?
6. Mulige tiltak
7. Kjente finansieringsmodeller
8. Forslag til statlig støtteordning eller tverr-offentlig finansieringspott
9. Hvordan prioritere hvilke prosjekter som bør støttes?
10. Spørsmål som bør vurderes videre
11. Foreløpig anbefaling for videre arbeid
12. Kilder og videre lesing

## Kilder og videre lesing

Denne siden bør knytte seg til kildelisten i arbeidsgruppen og særlig til kilder om finansiering, anskaffelser, EU-spor, sikkerhet og forvaltning.

### Internt underlag

- [ASR: Åpen kildekode arbeidsgruppe](https://digdir.github.io/ASR/apen-kildekode-arbeidsgruppe/)
- [ASR: Veiledning](https://digdir.github.io/ASR/apen-kildekode-arbeidsgruppe/veiledning/)
- [ASR: Tilskudd og bidrag](https://digdir.github.io/ASR/apen-kildekode-arbeidsgruppe/tilskudd-og-bidrag/)
- [ASR: Om arbeidet](https://digdir.github.io/ASR/apen-kildekode-arbeidsgruppe/om-arbeidet/)
- [ASR: Kilder](https://digdir.github.io/ASR/apen-kildekode-arbeidsgruppe/kilder/)
- [ASR: Kildeliste](https://digdir.github.io/ASR/apen-kildekode-arbeidsgruppe/kilder/kildeliste.html)
- [Notat fra NAV: Åpen kildekode i offentlig sektor](https://github.com/digdir/ASR/blob/main/docs/Notater%20fra%20Nav/notal.md)
- [Notat fra NAV: Hvordan kan vi bidra?](https://github.com/digdir/ASR/blob/main/docs/Notater%20fra%20Nav/tiltak.md)
- [KI-sammendrag: Tilskudd og bidrag](https://digdir.github.io/ASR/apen-kildekode-arbeidsgruppe/kilder/ki-sammendrag-tilskudd-og-bidrag.html)
- [KI-generert oppsummering av relevante EU-initiativer](https://digdir.github.io/ASR/apen-kildekode-arbeidsgruppe/kilder/ki-generert-oppsummering-av-relevante-eu-initiativer.html)

### EU og europeiske spor

- [EU Open Source Strategy](https://digital-strategy.ec.europa.eu/en/factpages/eu-open-source-strategy)
- [European Technological Sovereignty Package](https://digital-strategy.ec.europa.eu/en/policies/eu-tech-sovereignty)
- [Digital Europe Programme](https://commission.europa.eu/funding-and-tenders/find-funding/eu-funding-programmes/digital-europe-programme_en)
- [Digital Commons EDIC](https://digital-strategy.ec.europa.eu/en/policies/edic)
- [Interoperable Europe Act](https://interoperable-europe.ec.europa.eu/interoperable-europe/interoperable-europe-act)
- [OSOR: Funding Opportunities for Open Source Software Projects in the Public Sector](https://interoperable-europe.ec.europa.eu/collection/open-source-observatory-osor/funding-opportunities-open-source-software-projects-public-sector)
- [OSOR Handbook](https://interoperable-europe.ec.europa.eu/collection/open-source-observatory-osor/reports-and-guidelines)
...
- [Open Source Initiative: The 2026 State of Open Source Report](https://opensource.org/blog/the-2026-state-of-open-source-report)
- [Kubernetes: Ingress NGINX Retirement](https://www.kubernetes.dev/blog/2025/11/12/ingress-nginx-retirement/)
- [Brønnøysundregistrene: Om Støtteregisteret](https://www.brreg.no/om-oss/registrene-vare/om-stotteregisteret/)
