...
- prosjekt- og programfinansiering gjennom EU og andre virkemidler
- direkte finansiering eller medfinansiering fra offentlige virksomheter
- anskaffelser og kontrakter som finansierer utvikling, drift og vedlikehold
- kombinerte modeller med tjenesteinntekter, donasjoner, stiftelser og faglige bidrag
...
- hvilken offentlig nytte løsningen gir
- hvordan løsningen kan gjenbrukes av flere virksomheter
- hvordan finansieringen skal bidra til varig forvaltning, ikke bare førstegangsutvikling
- hvordan sikkerhet, dokumentasjon og fellesskapsarbeid skal håndteres
...
- kombinasjoner av offentlige midler, inntekter og donasjoner
- forsknings- og innovasjonsprogrammer
...
- arrangementer, hackathons og samhandlingsarenaer
- testmiljøer og kvalitetssikring
- koordinering på tvers av virksomheter

### Praktisk tolkning for norsk sammenheng

Direkte offentlige bidrag kan organiseres som:

- en vertsvirksomhet som tar et grunnansvar og finansierer kjerneforvaltning
- spleiselag mellom flere virksomheter som bruker samme løsning
- faste bidrag til en felles forvaltningsenhet eller et nasjonalt miljø
- øremerkede budsjettmidler til vedlikehold av kritiske åpne komponenter
...
- rettigheter til kildekode og videre bruk
- krav til dokumentasjon og overlevering
- vedlikeholdsansvar og feilretting
- hvordan andre leverandører eller virksomheter senere kan ta over eller bidra
...
- `SSA-T` for utvikling og tilpasning
- `SSA-S` for større smidige programvareanskaffelser
- `SSA-V` for vedlikehold, feilretting og nye versjoner
- `SSA-D` for drift
- `SSA-B` og `SSA-O` for bistand og oppdrag
- verktøy for innovasjonspartnerskap og før-kommersielle anskaffelser
...
- betalt support og forvaltning
- opplæring og rådgivning
- integrasjonstjenester og lokal tilpasning
- medlemskap eller partnerordninger
- donasjoner eller sponsorater til enkeltkomponenter
...
- løpende vedlikehold
- sikkerhet og oppgraderinger
- dokumentasjon
- koordinering av bidragsytere
- test, kvalitet og release-arbeid
- styring, prioritering og fellesskapsbygging
...
- klart mandat
- synlig styring og ansvar
- arenaer for samarbeid
- rom for frivillige og eksterne bidrag
- en katalog eller plattform som gjør gjenbruk lett å finne
...
- finansiere vedlikehold av åpne løsninger med dokumentert offentlig nytte
- styrke sikkerhet, kvalitet og etterlevelse i prosjekter som mange er avhengige av
- gjøre det lettere for små og mellomstore miljøer å etablere profesjonell forvaltning
- stimulere til mer gjenbruk mellom stat, kommune og andre offentlige aktører
- bygge fellesskap og kompetanse rundt løsninger som ellers blir sårbare
...
- har en realistisk plan for videre forvaltning
...
- forventet offentlig nytte og gjenbrukspotensial
...
- minimumskrav til sikkerhetsarbeid og avhengighetsstyring
- rapportering på gjenbruk, bidrag og effekter
...
- Developers Italia: Case Studies on Sustainability of Public Sector Open Source Communities
- Denmark explores the prerequisites for success in open source
- Open Technology Fund - Projects We Support
